...
const AddProperty = () => {
    ...
    return (
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <input className={styles.forminput} onChange={handleChange} type="number" name='plotArea' value={formData.area} placeholder='Enter Plot Area in sqft' step="0.01" min="0" required></input>
            <br/>
            ...
            <input className={styles.forminput} onChange={handleChange} type="number" name='price' value={formData.price} placeholder='Enter Property Price' step="0.01" min="0" required></input>
            <br/>
